...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.lbl_os_activate.setGeometry(QRect(130, 50, 181, 16))
        ...
        self.btn_activate_windows = QPushButton(self.centralwidget)
        self.btn_activate_windows.setObjectName(u"btn_activate_windows")
        self.btn_activate_windows.setGeometry(QRect(430, 370, 171, 24))
        ...
        self.btn_loop.setGeometry(QRect(590, 120, 221, 26))
        self.label_7 = QLabel(self.centralwidget)
        self.label_7.setObjectName(u"label_7")
        self.label_7.setGeometry(QRect(440, 470, 191, 16))
        self.label_8 = QLabel(self.centralwidget)
        self.label_8.setObjectName(u"label_8")
        self.label_8.setGeometry(QRect(440, 510, 191, 16))
        self.btn_ping_global = QPushButton(self.centralwidget)
        self.btn_ping_global.setObjectName(u"btn_ping_global")
        self.btn_ping_global.setGeometry(QRect(820, 470, 131, 24))
        self.lbl_global_net_name = QLabel(self.centralwidget)
        self.lbl_global_net_name.setObjectName(u"lbl_global_net_name")
        self.lbl_global_net_name.setGeometry(QRect(630, 470, 101, 16))
        self.lbl_local_net_name = QLabel(self.centralwidget)
        self.lbl_local_net_name.setObjectName(u"lbl_local_net_name")
        self.lbl_local_net_name.setGeometry(QRect(630, 510, 101, 16))
        self.lbl_local_net_status = QLabel(self.centralwidget)
        self.lbl_local_net_status.setObjectName(u"lbl_local_net_status")
        self.lbl_local_net_status.setGeometry(QRect(760, 510, 51, 16))
        self.lbl_global_net_status = QLabel(self.centralwidget)
        self.lbl_global_net_status.setObjectName(u"lbl_global_net_status")
        self.lbl_global_net_status.setGeometry(QRect(760, 470, 51, 16))
        self.btn_ping_local = QPushButton(self.centralwidget)
        self.btn_ping_local.setObjectName(u"btn_ping_local")
        self.btn_ping_local.setGeometry(QRect(820, 510, 131, 24))
        self.lbl_global_net_time = QLabel(self.centralwidget)
        self.lbl_global_net_time.setObjectName(u"lbl_global_net_time")
        self.lbl_global_net_time.setGeometry(QRect(970, 470, 51, 16))
        self.lbl_local_net_time = QLabel(self.centralwidget)
        self.lbl_local_net_time.setObjectName(u"lbl_local_net_time")
        self.lbl_local_net_time.setGeometry(QRect(970, 510, 51, 16))
        self.lbl_os_activate_office = QLabel(self.centralwidget)
        self.lbl_os_activate_office.setObjectName(u"lbl_os_activate_office")
        self.lbl_os_activate_office.setGeometry(QRect(160, 400, 251, 16))
        self.label_9 = QLabel(self.centralwidget)
        self.label_9.setObjectName(u"label_9")
        self.label_9.setGeometry(QRect(20, 400, 111, 16))
        self.label_10 = QLabel(self.centralwidget)
        self.label_10.setObjectName(u"label_10")
        self.label_10.setGeometry(QRect(880, 150, 101, 16))
        self.lbl_hour_city = QLabel(self.centralwidget)
        self.lbl_hour_city.setObjectName(u"lbl_hour_city")
        self.lbl_hour_city.setGeometry(QRect(990, 150, 221, 16))
        self.label_11 = QLabel(self.centralwidget)
        self.label_11.setObjectName(u"label_11")
        self.label_11.setGeometry(QRect(880, 170, 101, 16))
        self.lbl_date = QLabel(self.centralwidget)
        self.lbl_date.setObjectName(u"lbl_date")
        self.lbl_date.setGeometry(QRect(990, 170, 121, 16))
        self.lbl_time = QLabel(self.centralwidget)
        self.lbl_time.setObjectName(u"lbl_time")
        self.lbl_time.setGeometry(QRect(990, 190, 121, 16))
        self.label_12 = QLabel(self.centralwidget)
        self.label_12.setObjectName(u"label_12")
        self.label_12.setGeometry(QRect(880, 190, 101, 16))
        self.btn_set_time = QPushButton(self.centralwidget)
        self.btn_set_time.setObjectName(u"btn_set_time")
        self.btn_set_time.setGeometry(QRect(1040, 250, 181, 24))
        self.label_13 = QLabel(self.centralwidget)
        self.label_13.setObjectName(u"label_13")
        self.label_13.setGeometry(QRect(880, 220, 201, 16))
        self.lbl_time_auto = QLabel(self.centralwidget)
        self.lbl_time_auto.setObjectName(u"lbl_time_auto")
        self.lbl_time_auto.setGeometry(QRect(1090, 220, 121, 16))
        self.btn_sync_time = QPushButton(self.centralwidget)
        self.btn_sync_time.setObjectName(u"btn_sync_time")
        self.btn_sync_time.setGeometry(QRect(850, 250, 181, 24))
        MainWindow.setCentralWidget(self.centralwidget)
        self.menubar = QMenuBar(MainWindow)
        self.menubar.setObjectName(u"menubar")
        self.menubar.setGeometry(QRect(0, 0, 1226, 33))
