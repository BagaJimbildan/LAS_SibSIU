...
class Ui_DialogLoopFunction(object):
    def setupUi(self, DialogLoopFunction):
        ...
        DialogLoopFunction.resize(417, 413)
        self.groupBox = QGroupBox(DialogLoopFunction)
        self.groupBox.setObjectName(u"groupBox")
        self.groupBox.setGeometry(QRect(20, 20, 381, 341))
        self.cb_admin = QCheckBox(self.groupBox)
        self.cb_admin.setObjectName(u"cb_admin")
        self.cb_admin.setGeometry(QRect(20, 100, 331, 24))
        self.cb_pass_admin = QCheckBox(self.groupBox)
        self.cb_pass_admin.setObjectName(u"cb_pass_admin")
        self.cb_pass_admin.setGeometry(QRect(20, 130, 351, 24))
        self.cb_user = QCheckBox(self.groupBox)
        self.cb_user.setObjectName(u"cb_user")
        self.cb_user.setGeometry(QRect(20, 160, 311, 24))
        self.cb_windows = QCheckBox(self.groupBox)
        self.cb_windows.setObjectName(u"cb_windows")
        self.cb_windows.setGeometry(QRect(20, 190, 311, 24))
        self.cb_office = QCheckBox(self.groupBox)
        self.cb_office.setObjectName(u"cb_office")
        self.cb_office.setGeometry(QRect(20, 220, 311, 24))
        self.cb_name_pc = QCheckBox(self.groupBox)
        self.cb_name_pc.setObjectName(u"cb_name_pc")
        self.cb_name_pc.setGeometry(QRect(20, 250, 311, 24))
        self.cb_domain = QCheckBox(self.groupBox)
        self.cb_domain.setObjectName(u"cb_domain")
        self.cb_domain.setGeometry(QRect(20, 280, 311, 24))
        self.cb_network = QCheckBox(self.groupBox)
        self.cb_network.setObjectName(u"cb_network")
        self.cb_network.setGeometry(QRect(20, 310, 311, 24))
        self.cb_set_time = QCheckBox(self.groupBox)
        self.cb_set_time.setObjectName(u"cb_set_time")
        self.cb_set_time.setGeometry(QRect(20, 40, 331, 24))
        self.cb_sync_time = QCheckBox(self.groupBox)
        self.cb_sync_time.setObjectName(u"cb_sync_time")
        self.cb_sync_time.setGeometry(QRect(20, 70, 351, 24))
        self.btn_ok = QPushButton(DialogLoopFunction)
        self.btn_ok.setObjectName(u"btn_ok")
        self.btn_ok.setGeometry(QRect(280, 380, 121, 26))
        self.btn_cancel = QPushButton(DialogLoopFunction)
        self.btn_cancel.setObjectName(u"btn_cancel")
        self.btn_cancel.setGeometry(QRect(170, 380, 101, 26))
        QWidget.setTabOrder(self.cb_admin, self.cb_pass_admin)
        QWidget.setTabOrder(self.cb_pass_admin, self.cb_user)
        QWidget.setTabOrder(self.cb_user, self.cb_windows)
        QWidget.setTabOrder(self.cb_windows, self.cb_office)
        QWidget.setTabOrder(self.cb_office, self.cb_name_pc)
        QWidget.setTabOrder(self.cb_name_pc, self.cb_domain)
        QWidget.setTabOrder(self.cb_domain, self.cb_network)
        QWidget.setTabOrder(self.cb_network, self.btn_ok)
    ...
    def retranslateUi(self, DialogLoopFunction):
        ...
        self.cb_set_time.setText(QCoreApplication.translate("DialogLoopFunction", u"\u041d\u0430\u0441\u0442\u0440\u043e\u0439\u043a\u0430 \u0432\u0440\u0435\u043c\u0435\u043d\u0438", None))
        self.cb_sync_time.setText(QCoreApplication.translate("DialogLoopFunction", u"\u0421\u0438\u043d\u0445\u0440\u043e\u043d\u0438\u0437\u0430\u0446\u0438\u044f \u0432\u0440\u0435\u043c\u0435\u043d\u0438", None))
