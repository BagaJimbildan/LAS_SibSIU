...
class Ui_DialogDomainName(object):
    def setupUi(self, DialogDomainName):
        ...
        self.label_2.setGeometry(QRect(20, 130, 51, 20))
        self.tb_user = QLineEdit(DialogDomainName)
        self.tb_user.setObjectName(u"tb_user")
        self.tb_user.setGeometry(QRect(80, 80, 221, 31))
        self.lbl_domain = QLabel(DialogDomainName)
        self.lbl_domain.setObjectName(u"lbl_domain")
        self.lbl_domain.setGeometry(QRect(20, 50, 51, 16))
        self.label_3 = QLabel(DialogDomainName)
        self.label_3.setObjectName(u"label_3")
        self.label_3.setGeometry(QRect(40, 10, 401, 16))
        QWidget.setTabOrder(self.tb_domain, self.tb_user)
        QWidget.setTabOrder(self.tb_user, self.tb_pass)
        QWidget.setTabOrder(self.tb_pass, self.btn_ok)
