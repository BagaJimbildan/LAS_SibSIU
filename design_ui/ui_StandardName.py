...
class Ui_DialogStandardName(object):
    def setupUi(self, DialogStandardName):
        ...
        DialogStandardName.resize(692, 217)
        ...
        self.label_4 = QLabel(DialogStandardName)
        self.label_4.setObjectName(u"label_4")
        self.label_4.setGeometry(QRect(10, 160, 281, 16))
        self.btn_ok = QPushButton(DialogStandardName)
        self.btn_ok.setObjectName(u"btn_ok")
        self.btn_ok.setGeometry(QRect(588, 190, 101, 24))
        self.btn_cancel = QPushButton(DialogStandardName)
        self.btn_cancel.setObjectName(u"btn_cancel")
        self.btn_cancel.setGeometry(QRect(480, 190, 101, 24))
        ...
        self.lbl_error_num_cab.setGeometry(QRect(490, 60, 201, 16))
        self.lbl_error_num_inv = QLabel(DialogStandardName)
        self.lbl_error_num_inv.setObjectName(u"lbl_error_num_inv")
        self.lbl_error_num_inv.setGeometry(QRect(490, 90, 201, 16))
    ...
    def retranslateUi(self, DialogStandardName):
        ...
        self.label_4.setText(QCoreApplication.translate("DialogStandardName", u"\u0418\u0442\u043e\u0433\u043e\u0432\u043e\u0435 \u0438\u043c\u044f:", None))
        ...
        self.lbl_error_num_cab.setText("")
        self.lbl_error_num_inv.setText("")
    # retranslateUi
